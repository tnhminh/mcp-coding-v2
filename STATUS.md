...
- `npm run check`: lint + typecheck + 37 tests + build PASS.
...
## Active
P4-T01 — structured project task discovery/execution, followed by apply+verify and workspace/skill discovery. Git feature work is intentionally deferred.

## Known gaps
Production identity/authentication, audit and multi-user RBAC remain incomplete. Structured command runner/apply+verify, project Brain/context, browser/remote/deploy engines and broader observability remain incomplete. Git integration is deferred while local-project coding completeness is prioritized.
